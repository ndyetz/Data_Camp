...
The following documentoutlines the written portion of the lessons from [DataCamp](https://www.datacamp.com/)'s ["Introduction to R" course](https://www.datacamp.com/courses/free-introduction-to-r). This is a beginner course that requires little knowledge in R programming. 
...
Boolean values (```r TRUE``` or ```r FALSE```) are called **logical**.
...
```{r}
#Neil adding ticket_prices_matrix (Only avaliable in DataCamp)
...
comments <-  c("Best Horror Film I Have Ever Seen", "A truly brilliant and scary film from Stanley Kubrick", "A truly brilliant and scary film from Stanley Kubrick")
